##  lmtest: Testing Linear Regression Models (0.9-29)
  ...
  data = list())
{
  ...
  if(studentize)
  {
    ...
    method <- "studentized Breusch-Pagan test for homoscedasticity"
  }
  else
  {
    f <- resi^2/sigma2 -1
    ...
    bp <- 0.5 * sum(fv^2)
    method <- "Breusch-Pagan test for homoscedasticity"
  }
